...
<head>
	...
	<title>Tempe Bu Asri - Sistem Manajemen Toko</title>
	...
	<div class="wrapper">
		<header class="main-header">
			<a href="<?=base_url('dashboard')?>assets/index2.html" class="logo">
				...
				<span class="logo-lg">Tempe <b>Bu Asri</b></span>
			</a>
						...
						<ul class="treeview-menu">
							...
							<li <?=$this->uri->segment(1) == 'unit' ? 'class="active"' : ''?>>
								<a href="<?=site_url('unit')?>">
									<i class="fa fa-circle-o"></i> Units
								</a>
							</li>
      ...
      <?= $contents ?>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2022 <a href="https://yukcoding.id">Smtmtc</a>.</strong> All rights reserved.
		</footer>
