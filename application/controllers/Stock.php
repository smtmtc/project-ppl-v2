...
class Stock extends CI_Controller {
  ...
  public function stock_in_add(Type $var = null)
  {
  ...
  public function stock_in_del(Type $var = null)
  {
  ...
  public function stock_out_add(Type $var = null)
  {
    $item = $this->item_m->get()->result();
    $supplier = $this->supplier_m->get()->result();
    $data = ['item' => $item, 'supplier' => $supplier];
  ...
  public function stock_out_del(Type $var = null)
  {
    $stock_id = $this->uri->segment(4);
    $item_id = $this->uri->segment(5);
    $qty = $this->stock_m->get($stock_id)->row()->qty;
  ...
  public function proses(Type $var = null)
  {
